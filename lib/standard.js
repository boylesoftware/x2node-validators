...
exports.VALIDATOR_DEFS = {
	...
	'required': function(params, ctx, value) {

		if ((value === undefined) || (value === null)) {
			ctx.addError('{missing}');
		} else {
			const propDesc = ctx.currentPropDesc;
			const ptr = ctx.currentPointer;
	...
	'empty': function(params, ctx, value) {
	...
	'string': function(params, ctx, value) {
	...
	'number': function(params, ctx, value) {
	...
	'boolean': function(params, ctx, value) {
	...
	'datetime': function(params, ctx, value) {
	...
	'object': function(params, ctx, value) {
	...
	'array': function(params, ctx, value) {
	...
	'noDupes': function(params, ctx, value) {
	...
	'integer': function(params, ctx, value) {
	...
	'trim': function(params, ctx, value) {
	...
	'oneof': function(params, ctx, value) {
		...
		if (!params[0].some(validValue => (value === validValue)))
			ctx.addError('{invalidValue}');

		return value;
	},

	'lowercase': function(params, ctx, value) {
	...
	'uppercase': function(params, ctx, value) {
	...
	'email': function(params, ctx, value) {
	...
	'date': function(params, ctx, value) {

		if (((typeof value) === 'string') &&
			!/^\d{4}-(0[1-9]|1[1-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/.test(value))
	...
	'timeToSecond': function(params, ctx, value) {
	...
	'ccNumber': function(params, ctx, value) {
	...
	'bankRoutingNumber': function(params, ctx, value) {
	...
	'weekday2': function(params, ctx, value) {
	...
	'weekday3': function(params, ctx, value) {
	...
	'loc_US:state2': function(params, ctx, value) {
	...
	'loc_US:zip5': function(params, ctx, value) {
	...
	'loc_US:phone10': function(params, ctx, value) {
